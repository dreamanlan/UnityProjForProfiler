...
using UnityEngine;
using static Unity.MemoryProfilerExtension.Editor.QuickSearchUtility;
...
namespace Unity.MemoryProfilerExtension.Editor
{
    ...
    /// </summary>
    public static class EditorSessionUtility
    {
    ...
    public static class QuickSearchUtility
    {
        ...
        // This is less than ideal since the whole SearchDatabase API is public. But here is how you would tests if all indexes (i.e SearchDatabase) are ready.
    ...
    public static class EditorAssetFinderUtility
    {
