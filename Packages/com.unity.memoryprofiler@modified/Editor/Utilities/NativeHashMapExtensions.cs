...
namespace Unity.MemoryProfilerExtension.Editor.Extensions
{
    static class NativeHashMapExtensions
    {
        ...
        public static bool GetOrInitializeValue<TKey, TValue>(
            ...
            this Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<TKey, TValue> dictionary,
#else
...
#if !UNMANAGED_NATIVE_HASHMAP_AVAILABLE
            this Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<TKey, UnsafeList<TValue>> dictionary,
#else
