...
{
    public static class ManagedObjectTools
    {
        ...
        public static string ProduceManagedObjectName(this ManagedObjectInfo managedObjectInfo, CachedSnapshot snapshot, bool addInstanceId = false)
        {
