...
namespace Unity.MemoryProfilerExtension
{
    public interface IRefComparer<T> where T : unmanaged
    {
...
namespace Unity.MemoryProfilerExtension.Editor.Containers
{
    ...
    public static class DynamicArrayAlgorithms
    {
        ...
        /// <summary>
        /// Port of MSDN's public method for QuickSort, which works with <see cref="NativeArray{T}"/> and <see cref="DynamicArray{T}"/> data
