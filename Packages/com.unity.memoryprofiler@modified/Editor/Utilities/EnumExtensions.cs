...
namespace Unity.MemoryProfilerExtension.Editor.Extensions
{
    public static class EnumExtensions
    {
...
#endif
        public static ulong GetValueUnsigned<TEnum>(this TEnum enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
        ...
        [MethodImpl((MethodImplOptions)256)]
#endif
        public static long GetValue<TEnum>(this TEnum enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
        ...
        [MethodImpl((MethodImplOptions)256)]
#endif
        public static TEnum ConvertToEnum<TEnum>(byte enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
        ...
        [MethodImpl((MethodImplOptions)256)]
#endif
        public static TEnum ConvertToEnum<TEnum>(short enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
        ...
        [MethodImpl((MethodImplOptions)256)]
#endif
        public static TEnum ConvertToEnum<TEnum>(int enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
        ...
        [MethodImpl((MethodImplOptions)256)]
#endif
        public static TEnum ConvertToEnum<TEnum>(long enumValue) where TEnum :
#if CSHARP_7_3_OR_NEWER
        unmanaged, Enum
#else
        struct
