...
{
    public static class ManagedHeapArrayDataTools
    {
        ...
        public static string GenerateArrayDescription(CachedSnapshot cachedSnapshot, ArrayInfo arrayInfo, long arrayIndex, bool truncateTypeName, bool includeTypeName)
        {
