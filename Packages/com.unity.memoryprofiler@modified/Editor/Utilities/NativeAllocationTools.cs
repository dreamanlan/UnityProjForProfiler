...
{
    public static class NativeAllocationTools
    {
        ...
        public static string ProduceNativeAllocationName(SourceIndex nativeAllocation, CachedSnapshot snapshot, bool truncateTypeNames = true)
        {
