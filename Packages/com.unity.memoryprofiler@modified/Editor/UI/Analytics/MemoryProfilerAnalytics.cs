...
using System.Text;
using Unity.MemoryProfilerExtension.Editor.Analytics;
...
{
    // the public APIs for Analytic Events do not follow the correct naming guidelines and sometimes using odd variable names.
    ...
    // There is a fixed set of expected field names that will get processed. Please check our public Analytics spreadsheet, linked to from the Dashboard for more info.
    static class MemoryProfilerAnalytics
    {
        ...
        public struct CapturedSnapshotEvent : IDisposable
        {
            ...
            public CapturedSnapshotEvent(double startTime)
            {
        ...
        public struct LoadSnapshotEvent : IDisposable
        {
            ...
            public LoadSnapshotEvent(double startTime)
            {
                m_StartTime = startTime;
        ...
        [Flags]
        public enum SnapshotProjectAndUnityVersionDetails : int
        {
            None = 0,
            SameSession = 1 << 0,
            SameProject = 1 << 1,
        ...
        public readonly struct ImportSnapshotEvent : IDisposable
        {
            ...
            public ImportSnapshotEvent(double startTime)
            {
                m_StartTime = startTime;
            }
        ...
        public readonly struct OpenViewEvent : IDisposable
        {
            ...
            public OpenViewEvent(string viewName, double startTime)
            {
                m_ViewName = viewName;
                m_StartTime = startTime;
            }
