...
namespace Unity.MemoryProfilerExtension.Editor
{
    ...
    {
        // Opt-Out Dialog keys:
        public const string HeapWarningWindowOptOutKey = "Unity.MemoryProfilerExtension.HeapWarningPopup";

        const string k_LastImportPathPrefKey = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerLastImportPath";
        const string k_SnapshotPathEditorPerf = "Unity.MemoryProfilerExtension.Editor.MemorySnapshotStoragePath";
        const string k_MemoryProfilerPackageOverridesMemoryModuleUIEditorPerf = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerPackageOverridesMemoryModuleUI";
        const string k_DefaultPath = "./MemoryCaptures";
        const string k_TruncateTypes = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerTruncateTypes";
        const string k_ClickableCallStacks = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerClickableCallStacks";
        const string k_AddressInCallStacks = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerAddressInCallStacks";
        const string k_DefaultCopyOptionKey = "Unity.MemoryProfilerExtension.Editor.DefaultCopySelectedItemTitleOption";
        const string k_ShowReservedMemoryBreakdown = "Unity.MemoryProfilerExtension.Editor.ShowReservedMemoryBreakdown";
        const string k_ShowMemoryMapView = "Unity.MemoryProfilerExtension.Editor.ShowMemoryMapView";
        const string k_SnapshotCaptureFlagsKey = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerSnapshotCaptureFlags.v2"; // upgraded to v2 because the default changed
        const string k_SnapshotCaptureCaptureWithScreenshot = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerSnapshotCaptureWithScreenshot";
        const string k_SnapshotGCCollectWhenCapturingEditor = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerSnapshotGCCollectWhenCapturingEditor";
        const string k_CloseSnapshotsWhenCapturingEditor = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerCloseSnapshotsWhenCapturingEditor";
        const string k_ObjectDetailsReferenceSectionVisibleKey = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerObjectDetailsReferenceSectionVisibility";
        const string k_ObjectDetailsReferenceSectionSizeKey = "Unity.MemoryProfilerExtension.Editor.MemoryProfilerObjectDetailsReferenceSectionSize";
        const string k_AllocationRootsToSplitKey = "Unity.MemoryProfilerExtension.Editor.AllTrackedMemoryModelBuilder.AllocationRootsToSplit";
        ...
        internal static class FeatureFlags
        {
            ...
            // When changing this, update Unity.MemoryProfilerExtension.Tests.Helpers.ManagedCrawlerConsidersPointersToGCHandleHeldManagedObjects
            public static readonly bool ManagedCrawlerConsidersPointersToGCHandleHeldManagedObjects = true;
            // When changing this, update Unity.MemoryProfilerExtension.Tests.Helpers.ManagedCrawlerConsidersPointersToManagedObjects
            public const bool ManagedCrawlerConsidersPointersToManagedObjects = false;
            // When changing this, update Unity.MemoryProfilerExtension.Tests.Helpers.ManagedCrawlerConsidersPotentialPointersToManagedObjects
