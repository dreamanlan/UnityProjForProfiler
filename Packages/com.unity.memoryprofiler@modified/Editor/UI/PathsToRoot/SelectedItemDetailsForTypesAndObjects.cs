...
using System.Text;
using static Unity.MemoryProfilerExtension.Editor.CachedSnapshot.NativeAllocationSiteEntriesCache;

namespace Unity.MemoryProfilerExtension.Editor.UI
{
    public class SelectedItemDetailsForTypesAndObjects
    {
...
#pragma warning restore 0649
        ...
        public void HandleTypeDetails(UnifiedType type)
        {
            if (!type.IsValid)
                return;
        ...
        public void HandleObjectDetails(UnifiedType type)
        {
            if (!m_CurrentSelectionObjectData.IsValid)
                return;
        ...
        public void HandleNativeAllocationDetails(CachedSnapshot.SourceIndex source, string fallbackName, string fallbackDescription)
        {
            ...
            // Give a hint to public users or those with the potential to get call stacks.
        ...
        public void HandleGfxResourceDetails(CachedSnapshot.SourceIndex source, string fallbackName, string fallbackDescription)
        {
        ...
        public void HandleNativeRootReferenceDetails(CachedSnapshot.SourceIndex source, string fallbackName, string fallbackDescription, long childCount = -1)
        {
            m_UI.SetItemName(source);
        ...
        public void HandleInvalidObjectDetails(UnifiedType type, out string statusSummary)
        {
        ...
        public void HandlePureCSharpObjectDetails(UnifiedType type)
        {
            // Pure C# Type Objects
        ...
        public void HandleUnityObjectDetails(UnifiedUnityObjectInfo selectedUnityObject)
        {
        ...
        public void HandleGroupDetails(string title, string description)
        {
