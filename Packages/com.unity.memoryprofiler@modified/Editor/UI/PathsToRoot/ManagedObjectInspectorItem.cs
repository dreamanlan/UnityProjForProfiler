...
{
    public class ManagedObjectInspectorItem : TreeViewItem
    {
        ...
        public ManagedObjectInspectorItem(int managedInspectorId, long idx, CachedSnapshot cs)
        {
            m_InspectorID = managedInspectorId;
            m_Idx = idx;
            id = s_IdGenerator++;
        ...
        public ManagedObjectInspectorItem(int managedInspectorId, string name, int managedTypeIndex, string type, string value, bool isStatic, ulong identifyingPointer, ulong size)
        ...
        public ManagedObjectInspectorItem(int managedInspectorId, string name, int managedTypeIndex, string type, string value, bool isStatic, ulong identifyingPointer, string size)
        {
            m_InspectorID = managedInspectorId;
            id = s_IdGenerator++;
            DisplayName = name;
