...
{
    public static class PlayerConnectionCompatibilityHelper
    {
        ...
        public static string GetPlayerDisplayName(string playerName)
        {
            ...
            // we should technically never get here, unless the public API changed again. We actually want to be informed of that via the exception
