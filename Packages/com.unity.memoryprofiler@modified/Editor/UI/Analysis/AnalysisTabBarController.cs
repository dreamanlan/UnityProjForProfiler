...
{
    public class AnalysisTabBarController : TabBarController, IAnalysisViewSelectable
    {
        const string k_UxmlAssetGuid = "3b0e0e0ad7c2578478ee25b9b023562e";
        ...
        public AnalysisTabBarController(ISelectionDetails selectionDetails, CachedSnapshot baseSnapshot, CachedSnapshot compareSnapshot) : base()
        {
            ...
            MemoryModelViewControllerBlockboard.selectionDetails = selectionDetails;
            MemoryModelViewControllerBlockboard.tabBarController = this;
        }
        ...
        {
            MemoryModelViewControllerBlockboard.ClearComparison();
        ...
        {
            MemoryModelViewControllerBlockboard.ClearSingle();
