...
{
    public class UnityObjectsComparisonViewController : TreeViewController<UnityObjectsComparisonModel, UnityObjectsComparisonModel.ItemData>, UnityObjectsTableViewController.IResponder, IViewControllerWithVisibilityEvents
    {
        const string k_UxmlAssetGuid = "75d177e309407ad45a0d948a79462705";
            ...
            : base(idOfDefaultColumnWithPercentageBasedWidth: k_UxmlIdentifier_TreeViewColumn__Description)
        {
            ...
            MemoryModelViewControllerBlockboard.unityComparisonViewController = this;
        }

        public UnityObjectsComparisonModel Model => m_Model;
        ...
        protected override void ViewLoaded()
        {
            ...
            MemoryModelViewControllerBlockboard.unityComparisonBaseTableViewController = m_BaseTableViewController;
            MemoryModelViewControllerBlockboard.unityComparisonComparedTableViewController = m_ComparedTableViewController;
        }
