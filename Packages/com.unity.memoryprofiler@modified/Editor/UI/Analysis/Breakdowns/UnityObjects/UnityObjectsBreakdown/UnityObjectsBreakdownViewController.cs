...
{
    public class UnityObjectsBreakdownViewController : BreakdownViewController, UnityObjectsTableViewController.IResponder, IViewControllerWithVisibilityEvents
    {
        ...
        {
            MemoryModelViewControllerBlockboard.unitySingleViewController = this;
        }
        ...
        protected override void ViewLoaded()
        {
            ...
            MemoryModelViewControllerBlockboard.unitySingleTableViewController = m_TableViewController;
        }
