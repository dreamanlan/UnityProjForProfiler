...
{
    public class ResidentMemorySummaryViewController : ViewController, IMemorySummaryViewController
    {
        const string k_UxmlAssetGuid = "9ac1fe9c174f663428893c38aaad8bdb";
        ...
        const string k_UxmlDetailsPageAssetGuid = "d4474e4950a0a6f43918cb7330671c69";
        ...
        public MemorySummaryModel Model => m_Model;
        ...
        public void RowHovered(int index, bool state)
        {
