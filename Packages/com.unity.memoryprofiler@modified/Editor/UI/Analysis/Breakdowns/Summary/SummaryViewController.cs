...
{
    public class SummaryViewController : ViewController, IViewControllerWithVisibilityEvents
    {
        const string k_UxmlAssetGuid = "9b037be3b1989dc4a8a2714c14c87c1c";
        ...
        void RefreshView()
        {
            ...
            MemoryModelViewControllerBlockboard.residentSummaryViewController = residentMemoryController;
            MemoryModelViewControllerBlockboard.commitSummaryViewController = committedMemoryController;
            MemoryModelViewControllerBlockboard.managedSummaryViewController = managedMemoryController;
            MemoryModelViewControllerBlockboard.unitySummaryViewController = unityObjectController;
        }
