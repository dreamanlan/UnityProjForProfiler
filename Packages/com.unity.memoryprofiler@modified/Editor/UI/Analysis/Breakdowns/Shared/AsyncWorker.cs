...
{
    public abstract class BaseAsyncWorker : IDisposable
    {
    ...
    public class AsyncWorkerCoroutineDummyObject : ScriptableObject { }

    public class AsyncWorker<T> : BaseAsyncWorker
    {
