...
namespace Unity.MemoryProfilerExtension.Editor.UI
{
    ...
    public abstract class ComparisonViewController : TreeViewController<ComparisonTableModel, ComparisonTableModel.ComparisonData>
    {
        const string k_UxmlAssetGuid = "5618a8966ed5ed64aa66974d096748c3";
        ...
        public ComparisonTableModel Model => m_Model;
