...
namespace Unity.MemoryProfilerExtension.Editor.UI
{
    ...
    public class AllTrackedMemoryComparisonViewController : ComparisonViewController, AllTrackedMemoryTableViewController.IResponder, IAnalysisViewSelectable, IViewControllerWithVisibilityEvents
    {
            ...
            : base(snapshotA, snapshotB, description, AllTrackedMemoryComparisonTableModelBuilder.Build)
        {
            ...
            MemoryModelViewControllerBlockboard.memoryComparisonViewController = this;
        }
        ...
        protected override void ViewLoaded()
        {
            ...
            MemoryModelViewControllerBlockboard.memoryComparisonBaseTableViewController = m_BaseViewController;
            MemoryModelViewControllerBlockboard.memoryComparisonComparedTableViewController = m_ComparedViewController;
        }
