...
{
    public interface INamedTreeItemData
    {
        string Name { get; }
    }
    /// <summary>
    ...
    /// </summary>
    public abstract class TreeViewController<TModel, TTreeItemData> : ViewController where TModel : TreeModel<TTreeItemData> where TTreeItemData : INamedTreeItemData
    {
        // Model.
        ...
        public abstract ToolbarSearchField SearchField { get; }
