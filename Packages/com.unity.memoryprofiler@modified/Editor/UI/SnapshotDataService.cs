...
{
    public interface ISnapshotDataService
    {
    ...
    public class SnapshotDataService : IDisposable, ISnapshotDataService
    {
        ...
        public static CachedSnapshot LoadSnapshot(FileReader file)
        {
            if (!file.HasOpenFile)
                return null;
        ...
        public static void UnloadSnapshot(ref CachedSnapshot snapshot)
        {
            if (snapshot == null)
                return;
        ...
        public static SnapshotFileListModel BuildSnapshotsInfo(CancellationToken token, DirectoryInfo snapshotsDirectory, IReadOnlyList<SnapshotFileModel> snapshotInfos)
        {
        ...
        public static IEnumerable<string> GetSnapshotFiles(DirectoryInfo directory)
        {
            try
            {
                if (!directory.Exists)
