...
using TypeIndexMappingHashMap = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<int, int>;
using ConnectionsHashMap = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<Unity.MemoryProfilerExtension.Editor.CachedSnapshot.SourceIndex, Unity.Collections.LowLevel.Unsafe.UnsafeList<int>>;
using InvalidObjectsHashMap = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<long, Unity.MemoryProfilerExtension.Editor.ManagedObjectInfo>;
#else
...
using ConnectionsHashMap  = Unity.Collections.NativeHashMap<Unity.MemoryProfilerExtension.Editor.CachedSnapshot.SourceIndex, Unity.Collections.LowLevel.Unsafe.UnsafeList<int>>;
using InvalidObjectsHashMap  = Unity.Collections.NativeHashMap<long, Unity.MemoryProfilerExtension.Editor.ManagedObjectInfo>;
#endif

namespace Unity.MemoryProfilerExtension.Editor
{
    public class ManagedData : IDisposable
    {
        ...
        public void AddUpTotalMemoryUsage(CachedSnapshot.ManagedMemorySectionEntriesCache managedMemorySections)
        {
