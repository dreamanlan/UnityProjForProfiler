...
using Unity.Jobs;
using Unity.MemoryProfilerExtension.Editor.Containers;
...
using AddressToManagedIndexHashMap = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<ulong, long>;
using TypeIndexToCrawlerDataIndexHashMap = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<int, long>;
using AddressToInstanceId = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<ulong, Unity.MemoryProfilerExtension.Editor.InstanceID>;
using InstanceIdToNativeObjectIndex = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<Unity.MemoryProfilerExtension.Editor.InstanceID, long>;
using AddressToIndex = Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.NativeHashMap<ulong, long>;
#else
...
using AddressToInstanceId = Unity.Collections.NativeHashMap<ulong, Unity.MemoryProfilerExtension.Editor.InstanceID>;
using InstanceIdToNativeObjectIndex = Unity.Collections.NativeHashMap<Unity.MemoryProfilerExtension.Editor.InstanceID, long>;
...
namespace Unity.MemoryProfilerExtension.Editor.Managed
{
    static partial class ManagedDataCrawler
    {
        ...
        public const int JobifiedArrayCrawlingFieldCountThreshold = 1000;
        public const int MinFieldCountPerJobChunk = 150_000;
        ...
        public static ManagedObjectInfo ParseObjectHeader(CachedSnapshot snapshot, ulong addressOfHeader, out bool wasAlreadyCrawled, bool ignoreErrorsBecauseObjectIsSpeculative, BytesAndOffset byteOffset, int typeOfReferencingField)
        {
            ref var objectList = ref snapshot.CrawledData.ManagedObjects;
            var objectsByAddress = snapshot.CrawledData.MangedObjectIndexByAddress;
