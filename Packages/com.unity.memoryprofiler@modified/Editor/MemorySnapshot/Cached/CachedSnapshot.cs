...
using Unity.MemoryProfilerExtension.Editor.Containers.Unsafe;
...
namespace Unity.MemoryProfilerExtension.Editor
{
    ...
    public struct InstanceID : IEquatable<InstanceID>, IComparable<InstanceID>
    {
        ...
        public bool IsRuntimeCreated() => m_Id < 0;
    ...
    public static class ManagedMemorySectionEntriesCacheExtensions
    {
    ...
    public class CachedSnapshot : IDisposable
    {
        ...
        public ManagedData CrawledData { set; get; }
        ...
        public class EntriesMemoryMapCache : IDisposable
        {
            ...
            public EntriesMemoryMapCache(DynamicArray<AddressPoint> m_Data)
            {
                m_Snapshot = null;
