...
namespace Unity.MemoryProfilerExtension.Editor.Format
{
    public class MetaData
    {
        ...
        [NonSerialized]
        public ProfileTargetInfo? TargetInfo = null;
        [NonSerialized]
        public ProfileTargetMemoryStats? TargetMemoryStats = null;
    ...
    public readonly struct VirtualMachineInformation
    {
    ...
    public unsafe struct ProfileTargetMemoryStats : IEquatable<ProfileTargetMemoryStats>
    {
    ...
    public unsafe struct ProfileTargetInfo : IEquatable<ProfileTargetInfo>
    {
