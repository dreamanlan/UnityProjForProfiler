...
namespace Unity.MemoryProfilerExtension.Editor.UIContentData
{
    public static class TextContent
    {
        ...
        public static string NativeReservedDescription => "Reserved memory is memory that Unity allocated from the system (OS) but isn't used by any Unity objects at the moment of the capture. " +
            "There are many reasons why Unity might allocate memory for it public allocators:" +
    ...
    public static class FileExtensionContent
    {
