...
namespace Unity.MemoryProfilerExtension.Editor.Containers
{
    ...
    public static class MetaDataHelpers
    {
        ...
        public static bool GenerateMetaDataString(CachedSnapshot cs, long nativeObjectIndex, out List<(string, string)> metaDataStrings)
        {
        ...
        public static string GenerateVersionMismatchWarning(int playerVersion, int packageVersion)
        {
    ...
    public struct TextureMetaData : IMetaDataBuffer
    {
    ...
    public struct Texture2DMetaData : IMetaDataBuffer
    {
        enum ByteIndicies
        {
            IsReadable = 0,
    ...
    public struct MeshMetaData : IMetaDataBuffer
    {
        enum ByteIndicies
        {
            IndexFormat = 0,
    ...
    public struct RenderTextureMetaData : IMetaDataBuffer
    {
...
#pragma warning restore 0649
    ...
    public struct AudioClipMetaData : IMetaDataBuffer
    {
#pragma warning disable 0649
        const int kPackageFormatVersion = 1;
        public int Version;
...
#pragma warning restore 0649
    ...
    public struct ShaderMetaData : IMetaDataBuffer
    {
        const int kPackageFormatVersion = 1;
        public int Version;
