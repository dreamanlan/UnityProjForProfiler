...
using Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.LowLevel.Unsafe;
using Unity.Mathematics;

namespace Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility
{
    [NativeContainer]
    public unsafe struct NativeHashMapDispose
    {
        [NativeDisableUnsafePtrRestriction]
        public LowLevel.Unsafe.UnsafeHashMap<int, int>* m_HashMapData;
...
namespace Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.LowLevel.Unsafe
{
    //[GenerateTestsForBurstCompatibility]
    unsafe public struct Memory
    {
        public const long k_MaximumRamSizeInBytes = 1L << 40; // a terabyte
        ...
        public struct Unmanaged
        {
            ...
            public struct Array
            {
                ...
                public static void* Resize(void* oldPointer, long oldCount, long newCount, AllocatorManager.AllocatorHandle allocator,
                    long size, int align)
                {
                ...
                //[GenerateTestsForBurstCompatibility(GenericTypeArguments = new [] { typeof(int) })]
                public static T* Resize<T>(T* oldPointer, long oldCount, long newCount, AllocatorManager.AllocatorHandle allocator) where T : unmanaged
                {
        ...
        where TKey : unmanaged, IEquatable<TKey>
    {
        ...
        public unsafe struct Enumerator
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.KVPair<TKey, TValue> GetCurrent<TValue>()
                where TValue : unmanaged
            {
                return new Unity.MemoryProfilerExtension.Editor.Containers.CollectionsCompatibility.KVPair<TKey, TValue> { m_Data = m_Data, m_Index = m_Index };
            }
