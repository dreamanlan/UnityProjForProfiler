...
namespace DslExpression
{
    ...
    internal class DatetimeStrExp : SimpleExpressionBase
    {
        protected override CalculatorValue OnCalc(IList<CalculatorValue> operands)
        {
            ...
            if (operands.Count >= 1) {
                ...
                r = System.DateTime.Now.ToString(fmt);
            } else {
                r = System.DateTime.Now.ToString();
            }
            return r;
        }
    }
    internal class LongDateStrExp : SimpleExpressionBase
    {
        protected override CalculatorValue OnCalc(IList<CalculatorValue> operands)
        {
            var r = CalculatorValue.FromObject(System.DateTime.Now.ToLongDateString());
            return r;
        }
    }
    internal class LongTimeStrExp : SimpleExpressionBase
    {
        protected override CalculatorValue OnCalc(IList<CalculatorValue> operands)
        {
            var r = CalculatorValue.FromObject(System.DateTime.Now.ToShortDateString());
            return r;
        }
    }
    ...
    internal class ShortTimeStrExp : SimpleExpressionBase
    {
        protected override CalculatorValue OnCalc(IList<CalculatorValue> operands)
        {
            var r = CalculatorValue.FromObject(System.DateTime.Now.ToShortTimeString());
            return r;
        }
    }
            ...
            if (operands.Count >= 1) {
                ...
                if (operands.Count >= 2) {
                    ...
                    if (!string.IsNullOrEmpty(name)) {
                        ...
                        CsLibrary.GmCommands.GlobalDebugValues.SetValue(name, valStr);
                        ret = valStr;
                    }
                } else {
                    ret = CsLibrary.GmCommands.GlobalDebugValues.GetStringValue(name);
                }
            }
            return ret;
        }
    ...
    internal class StoryValueExp : AbstractExpression
    {
        protected override CalculatorValue DoCalc()
        {
            ...
            if (null == instance) {
                string txt = "script(main){onmessage(\"start\"){};};";
                CsLibrary.GmCommands.ClientGmStorySystem.Instance.LoadStoryText(Encoding.UTF8.GetBytes(txt));
                CsLibrary.GmCommands.ClientGmStorySystem.Instance.StartStory("main");
                instance = CsLibrary.GmCommands.ClientGmStorySystem.Instance.GetStory("main");
            }
