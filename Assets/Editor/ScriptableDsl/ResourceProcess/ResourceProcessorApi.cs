...
internal static class ResourceEditUtility
{
    ...
    internal static void InitCalculator(DslCalculator calc)
    {
        ...
        calc.Register("getalldslfiles", new ExpressionFactoryHelper<ResourceEditApi.GetAllDslFilesExp>());
        calc.Register("buildassetstringlist", new ExpressionFactoryHelper<ResourceEditApi.BuildAssetStringListExp>());
        calc.Register("createrefasset", new ExpressionFactoryHelper<ResourceEditApi.CreateRefAssetExp>());
